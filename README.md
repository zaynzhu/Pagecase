...
- **本地资料管理** — 支持带确认的删除、完整资料库备份，以及 Chrome 快照与 Safari 合集分开导出。
...
当前 0.6.0 版本已通过 82 项 Swift 核心行为检查、10 项扩展测试、Bridge 协议往返、Chrome 扩展与 Safari 捕获静态安全检查、Release 构建、浅深色视觉验收和 500 页性能验收。
